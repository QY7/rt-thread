...
// INT4.6 - Reserved
// INT 4.7
void INTERRUPT HRCAP1_INT_ISR(void)    // HRCAP-1
{
  // Insert ISR Code here
...
// INT 4.8
void INTERRUPT HRCAP2_INT_ISR(void)    // HRCAP-2
{
  // Insert ISR Code here
...
// INT6.3
void INTERRUPT SPIRXINTB_ISR(void)    // SPI-B
{
  // Insert ISR Code here
...
// INT6.4
void INTERRUPT SPITXINTB_ISR(void)     // SPI-B
{
  // Insert ISR Code here
...
void INTERRUPT DINTCH5_ISR(void)     // DMA-Channel 5
{

  for(;;);
}

void INTERRUPT DINTCH6_ISR(void)     // DMA-Channel 6
{
...
void INTERRUPT ECANA_INT1_ISR(void)     // I2C-A
{
