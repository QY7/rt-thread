...
struct GPIO_CTRL_REGS {
	...
	union  GPB1_REG	   GPBMUX1;   // GPIO B Mux 1 Register (GPIO32 to 44)	08
	...
	union  AIODIR_REG   AIODIR;	  // Analog IO Direction Register (AIO0 to 15)			2c	   		   
	union  GPADAT_REG   GPAPUD;	  // GPIO A Pull Up Disable Register (GPIO0 to 31)		30
	union  GPBDAT_REG   GPBPUD;	  // GPIO B Pull Up Disable Register (GPIO32 to 44)		34
